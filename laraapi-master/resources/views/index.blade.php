              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <p>
                    Welcome to BT NOC. Kindly register to get approval 
                    
                    </p>
                    <div class="btn-box">
                      <a href="#" class="btn-1" data-toggle="modal" data-target="#approveFormModal">
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="approveFormModalLabel">Registration Form</h5>
